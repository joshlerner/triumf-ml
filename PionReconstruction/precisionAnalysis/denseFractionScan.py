...
if len(sys.argv) == 2 and sys.argv[1] in ['weight', 'accum', 'bias', 'result']:
    comp = sys.argv[1]
else:
    print('Usage: denseFractionScan.py [type] (where type is one of "weight", "accum", "bias", or "result".')
    sys.exit()

parent_dir = '/home/joshualerner/start_tf/PionReconstruction/'
temp_dir = parent_dir + f'data/temp_{comp}/'
