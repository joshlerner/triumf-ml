...
temp_dir = parent_dir + f'data/temp2_{comp}/'
...
print('\nGarNet Integer Bit Scan:')

for integ in range(0, 14):
    frac = 10
    bitwidth = frac + integ
